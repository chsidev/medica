...
@section('content')
    <div class="flex h-screen flex flex-col flex-1 mx-auto">
        ...
        <main class="h-full pb-16 overflow-y-auto">
            <div class="container flex flex-col  px-6 max-w-[330px] mx-auto">
                <h2 class="my-8 text-2xl font-semibold text-gray-700">
                </h2>
                <h2 class="my-8 text-2xl font-semibold text-gray-700">
                </h2>
                ...
                <h2 class="my-1 text-2xl font-bold text-gray-700">
                    Sarina!
                </h2>
                <h1 class="my-2 text-md text-gray-700 text-semibold">
                ...
                <div class="flex flex-row text-center">
                    <div>
                        <button class="flex items-center px-1">
                            <div class="container flex flex-col items-center w-12">
                                <img
                                    class="object-fill w-12 h-15 rounded-lg"
                        ...
                        <button class="flex items-center px-1">
                            <div class="container flex flex-col items-center w-12">
                                <img
                                    ...
                                    aria-hidden="true"
                                />
                                <p class="text-xs text-gray-600">Manic</p>
                            </div>
                        </button>
                    </div>
        ...
        <footer class="z-10 py-2 bg-white shadow-md visible md:hidden">
                    ...
                    <div>
                        <a class="flex items-center px-4">
                            <div class="container flex flex-col items-center w-8">
                                <i class="fas fa-home text-blue-600 text-xl"></i>
                                <p class="text-blue-600 text-xs">Home</p>
                            </div>
                        </a>
                    </div>
