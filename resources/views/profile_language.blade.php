...
@section('content')
    <div class="h-screen bg-white">
        ...
        <main class="h-[84vh] overflow-y-auto max-w-[768px] mx-auto">
            <div class="container mt-2 px-3 mx-auto">
                <div class="container py-2 flex flex-row min-w-screen overflow-x-auto mx-auto">
                    <P class="text-sm font-bold text-left pl-5 pt-1">
                        Suggested
                    </P>
                </div>
                <div class="container py-2 flex flex-row min-w-screen overflow-x-auto mx-auto">
                    <P class="text-sm text-left pl-5 pt-1">
                        English (US)
                    </P>
                    <div class="block grow text-right px-2">
                        <input id="default-radio-1" type="radio" value="" name="default-radio" class="w-4 h-4 text-blue-600 bg-gray-100 border-blue-600 focus:ring-blue-500 dark:focus:ring-blue-600 dark:ring-offset-gray-800 focus:ring-3 dark:bg-gray-700 dark:border-gray-600" checked>
                    </div>
                </div>
                <div class="container py-2 flex flex-row min-w-screen overflow-x-auto mx-auto">
                    <P class="text-sm text-left pl-5 pt-1">
                    ...
                    <div class="block grow text-right px-2">
                        <input id="default-radio-1" type="radio" value="" name="default-radio" class="w-4 h-4 text-blue-600 bg-gray-100 border-blue-600 focus:ring-blue-500 dark:focus:ring-blue-600 dark:ring-offset-gray-800 focus:ring-3 dark:bg-gray-700 dark:border-gray-600">
                    </div>
                </div>
                <div class="px-4 mt-3"><div class="w-full bg-gray-100 border-b"></div></div>
                <div class="container py-2 flex flex-row min-w-screen overflow-x-auto mx-auto">
                    <P class="text-sm font-bold text-left pl-5 pt-1">
                        Language
                    </P>
