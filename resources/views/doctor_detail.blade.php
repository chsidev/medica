    ...
    <div class="h-screen bg-white">
                    ...
                    <ul class="flex flex-col p-4 mt-4 bg-gray-50 rounded-lg border border-gray-100 md:flex-row md:space-x-8 md:mt-0 md:text-sm md:font-medium md:border-0 md:bg-white">
                        ...
                        <li>
                            <a href="{{route('doctors')}}" class="block py-2 pr-4 pl-3 text-gray-600 bg-blue-600 rounded md:bg-transparent md:text-gray-600 md:p-0" aria-current="page">
                                ...
                                <span class="pl-2 text-blue-600">Appointment</span>
                            </a>
                        </li>
                        <li>
        ...
        <header class="h-[8vh] min-h-[60px] flex flex-col z-10 px-4 bg-white text-gray-700 max-w-[1024px] mx-auto">
            <div class="container mt-6 flex flex-row text-center min-w-screen overflow-x-auto px-2 py-1 mx-auto">
                <a href="{{route('doctors')}}" class="pt-2 pb-2 md:hidden">
                ...
                <div class="block grow text-right pt-2">
                    <i class="fa-regular fa-heart pr-3"></i>
        ...
        <main class="h-[84vh] md:h-[75vh] overflow-y-auto max-w-[1024px] mx-auto">
            ...
            <div class="container flex flex-col items-center mx-auto pt-8">
                <div class="flex flex-row text-center items-center">
                    <div class="flex items-center px-2">
                        <div class="container flex flex-col items-center w-16">
                            <div class="w-12 h-12 bg-blue-200 rounded-full align-middle">
                                <i class="fas fa-users text-blue-600 text-xl bg-blue-200 pt-4 rounded-full"></i>
                            </div>
                            <p class="text-blue-600 text-xs pt-2">5,000+</p>
                            <p class="text-gray-600 text-[10px] pt-1">patients</p>
                        </div>
                    </div>
                    <div class="flex items-center px-2">
                        <div class="container flex flex-col items-center w-16">
                            <div class="w-12 h-12 bg-blue-200 rounded-full align-middle">
                                <img
                                    class="bg-blue-200 m-4"
                                    src="/images/experience1.png"
                                    alt=""
                                    aria-hidden="true"
                                />
                            </div>
                            <p class="text-blue-600 text-xs pt-2">10+</p>
                            <p class="text-gray-600 text-[10px] pt-1">years exper..</p>
                        </div>
                    </div>
                    <div class="flex items-center px-2">
                        <div class="container flex flex-col items-center w-16">
                            <div class="w-12 h-12 bg-blue-200 rounded-full align-middle">
                                <i class="fas fa-star-half-stroke text-blue-600 text-xl bg-blue-200 pt-4 rounded-full"></i>
                            </div>
                            <p class="text-blue-600 text-xs pt-2">4.8</p>
                            <p class="text-gray-600 text-[10px] pt-1">rating</p>
                        </div>
                    </div>
                    <div class="flex items-center px-2">
                        <div class="container flex flex-col items-center w-16">
                            <div class="w-12 h-12 bg-blue-200 rounded-full align-middle">
                                <i class="fas fa-comment-dots text-blue-600 text-xl bg-blue-200 pt-4 rounded-full"></i>
                            </div>
                            <p class="text-blue-600 text-xs pt-2">4,942</p>
                            <p class="text-gray-600 text-[10px] pt-1">reviews</p>
                        </div>
                    </div>
            ...
            <div class="container flex flex-col mx-auto pt-5">
                <h2 class="my-1 text-ls font-semibold pl-3">
                    About me
                </h2>
                <p class="text-xs px-3">
                ...
                <h2 class="my-1 text-ls font-semibold pl-3 pt-3">
                    Working Time
                </h2>
                <p class="text-xs px-3">
                    Monday - Friday, 08:00 AM - 20:00 AM
                </p>
                <div class="flex">
                    <div class="flex text-left">
                        <h2 class="my-1 text-ls font-semibold pl-3 pt-3">
                    ...
                    <a href="" class="block grow text-right">
                        <p class="block grow text-right pt-4 pr-4 text-blue-600 text-sm text-bold">
                            See All
                        </p>
                    </a>
                </div>
                <div class="flex p-3 bg-white rounded-lg shadow-xs">
                    ...
                    <div class="p-2 block grow">
                        <div class="flex">
                            ...
                            <div class="block grow text-right">
                                <button class="px-3 py-1 text-sm font-bold text-blue-600 transition-colors duration-150 border border-blue-600 rounded-full">
                                    <i class="fas fa-star pr-3"></i> 5
                                </button>
                                <svg class="w-[18px] inline pb-[5px]"  xmlns="http://www.w3.org/2000/svg"  viewBox="0 0 512 512" fill="#4c4f52">
                                    <path d="M256 8C119 8 8 119 8 256s111 248 248 248 248-111 248-248S393 8 256 8zm0 448c-110.5 0-200-89.5-200-200S145.5 56 256 56s200 89.5 200 200-89.5 200-200 200zM144 218c-17.7 0-32 14.3-32 32s14.3 32 32 32 32-14.3 32-32-14.3-32-32-32zm112 0c-17.7 0-32 14.3-32 32s14.3 32 32 32 32-14.3 32-32-14.3-32-32-32zm112 0c-17.7 0-32 14.3-32 32s14.3 32 32 32 32-14.3 32-32-14.3-32-32-32z"/>
                                </svg>
                ...
                <p class="text-xs px-3 bg-white">
                    Dr. Jenny is very professional in her work and responsive. I have consulted and my problem is solved. (*_*)
                </p>
            </div>
        </main>
        <footer class="h-[8vh] z-10 py-2 bg-white shadow-md border border-gray-200 rounded-t-xl">
            <div class="container flex flex-col items-center rounded-l-lg px-10">
                <button class="py-1 text-xs font-bold text-white transition-colors duration-150 border border-blue-600 rounded-full bg-blue-600 w-full h-10 max-w-[200px]">
                    Book Appointment
                </button>
            </div>
        </footer>
