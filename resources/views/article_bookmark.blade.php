    ...
    <div class="h-screen bg-white">
        ...
        <header class="h-[16vh] min-h-[120px] flex flex-col z-10 px-4 bg-white text-gray-700 max-w-[1024px] mx-auto">
            <div class="container mt-6 flex flex-row text-center min-w-screen overflow-x-auto px-2 py-1 mx-auto">
                <a href="{{route('article')}}" class="pt-2 pb-2 md:hidden">
        ...
        <main class="h-[84vh] md:h-[72vh] overflow-y-auto max-w-[1024px] mx-auto">
            <div class="pt-1 pb-8">
                <a href="{{route('article.detail')}}">
                    <div class="container mt-1 px-1 mx-auto">
                    ...
                    <div class="container mt-1 px-1 mx-auto">
                        <div class="flex p-2 bg-white rounded-xl shadow-xs">
                            ...
                            <div class="px-2 flex flex-col justify-between my-2">
                                ...
                                <p class="text-xs font-semibold text-gray-700 mt-0 mb-auto">
                                    Study Finds Being 'Hungry' is a Real Thing
                                </p>
                                <div class="">
                                    <button class="bg-blue-100 text-blue-600 rounded-lg text-[10px] p-1">
                                        Health
