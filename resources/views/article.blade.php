    ...
    <div class="h-screen bg-white">
        ...
        <header class="h-[8vh] min-h-[60px] flex flex-col z-10 px-4 bg-white text-gray-700 max-w-[1024px] mx-auto">
            <div class="container mt-6 flex flex-row text-center min-w-screen overflow-x-auto px-2 py-1 mx-auto">
                <img
                    class="rounded-lg pr-2 m-1 md:hidden"
                ...
                <div class="block grow text-right pt-1" id="grpButtons">
                    <a><i class="fas fa-search pr-3"></i></a>
                    <a href="{{route('article.bookmark')}}"><i class="fa-regular fa-bookmark pr-3"></i></a>
                ...
                <div class="grow relative" id="frmSearch" hidden>
                    ...
                    <a onclick="" class="absolute right-2.5 bottom-2.5 font-medium rounded-lg text-sm">
        ...
        <main class="h-[84vh] md:h-[82vh] overflow-y-auto max-w-[1024px] mx-auto">
            <div class="container flex flex-col mx-auto pt-2">
                <div class="flex">
                    <h2 class="my-1 text-ls font-semibold pl-3 pt-2">
                        Trending
                    </h2>
                    <p class="block grow text-right pt-3 pr-4 text-blue-600 text-sm text-bold text-right">
                        <a href="">
                            See All
                        </a>
                    </p>
                ...
                <div class="container flex flex-row text-center min-w-screen overflow-x-auto p-2 mx-auto">
                    <div class="px-1 rounded-xl w-[160px] md:w-[220px]">
                        <img
                            class="rounded-xl w-[150px] max-w-[200px] md:w-[200px]"
                            src="/images/trending1.png"
                            alt=""
                            aria-hidden="true"
                        />
                        <p class="text-xs font-semibold text-gray-700 text-left">
            ...
            <div class="container mx-auto pt-2">
                ...
                <div class="container flex flex-row text-center min-w-screen overflow-x-auto p-2 mx-auto">
                    <div class="px-1">
                        <input type="radio" id="cate_newest" name="cate" value="cate_newest" class="hidden peer" checked>
                        <label for="cate_newest" class="inline-flex justify-between items-center px-3 py-1 w-full text-sm font-bold text-blue-600 bg-white rounded-full border border-blue-600 cursor-pointer peer-checked:border-blue-600 peer-checked:text-white peer-checked:bg-blue-600 hover:text-white hover:bg-blue-600">
                            Newest
                        </label>
                    </div>
                    <div class="px-1">
                        <input type="radio" id="cate_health" name="cate" value="cate_health" class="hidden peer">
                        <label for="cate_health" class="inline-flex justify-between items-center px-3 py-1 w-full text-sm font-bold text-blue-600 bg-white rounded-full border border-blue-600 cursor-pointer peer-checked:border-blue-600 peer-checked:text-white peer-checked:bg-blue-600 hover:text-white hover:bg-blue-600">
                            Health
                        </label>
                    </div>
                    <div class="px-1">
                        <input type="radio" id="cate_covid" name="cate" value="cate_covid" class="hidden peer">
                        <label for="cate_covid" class="inline-flex justify-between items-center px-3 py-1 w-full text-sm font-bold text-blue-600 bg-white rounded-full border border-blue-600 cursor-pointer peer-checked:border-blue-600 peer-checked:text-white peer-checked:bg-blue-600 hover:text-white hover:bg-blue-600">
                            Covid_19
                        </label>
                    </div>
                    <div class="px-1">
                        <input type="radio" id="cate_lifestyle" name="cate" value="cate_lifestyle" class="hidden peer">
                        <label for="cate_lifestyle" class="inline-flex justify-between items-center px-3 py-1 w-full text-sm font-bold text-blue-600 bg-white rounded-full border border-blue-600 cursor-pointer peer-checked:border-blue-600 peer-checked:text-white peer-checked:bg-blue-600 hover:text-white hover:bg-blue-600">
                            Lifestyle
                        </label>
                    </div>
                </div>
                <div class="container mt-5 px-1 mx-auto">
                    <div class="flex p-2 bg-white rounded-xl shadow-xs">
                        <div class="rounded-xl w-[100px]">
                            <img
                                class="rounded-xl w-[100px] max-w-[200px]"
                                src="/images/covid1.png"
                                alt=""
                                aria-hidden="true"
                            />
                        </div>
                        <div class="px-2 flex flex-col justify-between my-2">
                            <div class="text-left">
                                <p class="mb-2 text-[10px] font-bold text-gray-600">
                                    Dec 22.2022
                                </p>
                            </div>
                            <p class="text-xs font-semibold text-gray-700 mt-0 mb-auto">
                                COVID-19 Was a Top Cause of Death in 2020 and 2021, Even For Younger People
                            </p>
                            <div class="">
                                <button class="bg-blue-100 text-blue-600 rounded-lg text-[10px] p-1">
                                    Covid-19
                                </button>
                            </div>
                        </div>
        ...
        <footer class="h-[8vh] z-10 py-2 bg-white shadow-md md:hidden">
                ...
                <div class="flex flex-row text-center">
                    ...
                    <div>
                        <a href="{{route('article')}}" class="flex items-center px-4">
                            <div class="container flex flex-col items-center w-8">
                                <i class="fa-regular fa-file-lines text-xl text-blue-600"></i>
                                <p class="text-xs text-blue-600">Articles</p>
                            </div>
                        </a>
                    </div>
                    <div>
                        <a href="{{route('profile')}}" class="flex items-center px-4">
                            <div class="container flex flex-col items-center w-8">
